...
define('DEFAULT_UNKNOWN', 'Unknown');
define('DEFAULT_CONTROLLER', 'Calendar'); // Dit is de standaard controller waarmee de webapplictie wordt opgestart
define('DEFAULT_ACTION', 'index'); // Dit is de standaard action waarmee de webapplictie wordt opgestart
define('PATH_CONTROLLER', ROOT . 'controller/'); // Dit is de standaard action waarmee de webapplictie wordt opgestart
